...
MACRO (ROOT_GENERATE_DICTIONARY INFILES LINKDEF_FILE OUTFILE INCLUDE_DIRS_IN)
  ...
  MESSAGE(STATUS "if (CMAKE_SYSTEM_NAME MATCHES Linux)")
    ADD_CUSTOM_COMMAND(OUTPUT ${OUTFILES}
  ...
  MESSAGE(STATUS "else (CMAKE_SYSTEM_NAME MATCHES Linux)")
    if (CMAKE_SYSTEM_NAME MATCHES Darwin)
    MESSAGE(STATUS "if (CMAKE_SYSTEM_NAME MATCHES Darwin)")
      ADD_CUSTOM_COMMAND(OUTPUT ${OUTFILES}
...
MACRO (GENERATE_ROOT_DICT_PROJECT name INFILES LINKDEF_FILE OUTFILE INCLUDE_DIRS_IN)
  set(INCLUDE_DIRS)
 ...
 FILE(WRITE ${CMAKE_CURRENT_BINARY_DIR}/${dictFile} "  ")
  
 
 
  add_custom_target(${name}
   ${ROOT_CINT_EXECUTABLE} -f ${OUTFILE} -c -p  ${INFILES} ${LINKDEF_FILE} 
)

ENDMACRO(GENERATE_ROOT_DICT_PROJECT)
